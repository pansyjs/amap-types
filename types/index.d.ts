...
/// <reference path="./core/bounds.d.ts" />
/// <reference path="./core/lngLat.d.ts" />
/// <reference path="./core/pixel.d.ts" />
/// <reference path="./core/size.d.ts" />

/// <reference path="./layer/buildings.d.ts" />
/// <reference path="./layer/labels-layer.d.ts" />
/// <reference path="./layer/layer.d.ts" />
/// <reference path="./layer/layer-group.d.ts" />
/// <reference path="./layer/mass-marks.d.ts" />
/// <reference path="./layer/tile-layer.d.ts" />

/// <reference path="./overlay/bezier-curve.d.ts" />
/// <reference path="./overlay/circle-marker.d.ts" />
...
/// <reference path="./overlay/overlay-group.d.ts" />
/// <reference path="./overlay/path-overlay.d.ts" />
